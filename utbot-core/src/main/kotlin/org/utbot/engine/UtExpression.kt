...
data class UtNegExpression(val variable: UtExpression) : UtExpression(alignSort(variable.sort)) {
    override val hashCode = Objects.hash("not", variable)

    override fun <TResult> accept(visitor: UtExpressionVisitor<TResult>): TResult = visitor.visit(this)

    override fun toString() = "(neg ${variable})"
...
data class UtCastExpression(val variable: UtExpression, override val sort: UtSort) : UtExpression(sort) {
