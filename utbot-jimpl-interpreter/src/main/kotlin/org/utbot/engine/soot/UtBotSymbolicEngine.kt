...
import org.utbot.engine.soot.util.mockListeners.MockListener
import org.utbot.engine.soot.util.mockListeners.MockListenerController
...
import org.utbot.engine.SymbolicState
...
// TODO: axiom instantiating visitor?
class JimpleVisitorFactory(private val typeRegistry: TypeRegistry): VisitorFactory() {
    override fun rewritingVisitor(constraints: Set<UtBoolExpression>,
                              eqs: Map<UtExpression, UtExpression>,
                              lts: Map<UtExpression, Long>,
                              gts: Map<UtExpression, Long>) =
        JimpleRewritingVisitor(constraints, eqs, lts, gts)
    override fun z3TranslatorFactory(z3Context: Context) = JimpleZ3TranslatorVisitor(z3Context, typeRegistry)
}
...
class UtBotSymbolicEngine(
    ...
    private val visitorFactory: VisitorFactory = JimpleVisitorFactory(typeRegistry)
    ...
    private fun traverseImpl(): Flow<UtResult> = flow {
        ...
        val initState = ExecutionState(
            initStmt,
            SymbolicState(UtSolver(visitorFactory, trackableResources, solverTimeoutInMillis)),
