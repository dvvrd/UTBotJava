package org.utbot.engine.soot.util.statics.concrete
...
import org.utbot.engine.soot.MethodResult
import org.utbot.engine.soot.SymbolicSuccess
import org.utbot.engine.soot.ObjectValue
import org.utbot.engine.soot.SymbolicValue
import org.utbot.engine.soot.SymbolicStateUpdate
import org.utbot.engine.soot.TypeResolver
import org.utbot.engine.soot.Traverser
import org.utbot.engine.soot.toMethodResult
import org.utbot.engine.soot.constructEnumStaticFieldResult
import org.utbot.engine.soot.canRetrieveBody
import org.utbot.engine.soot.memoryChunkDescriptor
import org.utbot.engine.soot.staticInitializerOrNull
import org.utbot.engine.soot.jimpleBody
import org.utbot.engine.soot.refType
import org.utbot.engine.soot.fieldId
...
fun Traverser.makeEnumNonStaticFieldsUpdates(
    ...
    for ((i, enumConstantSymbolicValue) in enumConstantSymbolicValues.withIndex()) {
        nonStaticFields.forEach { (sootNonStaticField, nonStaticFieldRuntimeValues) ->
            ...
            val descriptor = memoryChunkDescriptor(chunkId, enumConstantSymbolicValue.refType, fieldType)
