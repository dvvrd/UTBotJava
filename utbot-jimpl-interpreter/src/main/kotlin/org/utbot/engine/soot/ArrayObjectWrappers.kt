...
import org.utbot.engine.UtArrayInsert
import org.utbot.engine.UtArrayInsertRange
import org.utbot.engine.UtArrayRemove
import org.utbot.engine.UtArrayRemoveRange
import org.utbot.engine.UtArraySetRange
import org.utbot.engine.UtArrayShiftIndexes
...
import org.utbot.engine.mkArrayWithConst
...
class RangeModifiableUnlimitedArrayWrapper : WrapperInterface {
        ...
        return when (method.name) {
            ...
            "insert" -> {
                val value = UtArrayInsert(
                    ...
                    (parameters[0] as PrimitiveValue).expr,
                    parameters[1].addr
                )
            ...
            "insertRange" -> {
                val value = UtArrayInsertRange(
                    ...
                    (parameters[2] as PrimitiveValue).expr,
            ...
            "toArray" -> {
                ...
                val value = UtArrayShiftIndexes(getStorageArrayExpression(wrapper), offset.expr)
    ...
    override fun value(resolver: Resolver, wrapper: ObjectValue): UtModel {
        ...
        val storageFieldArrayDescriptor = memoryChunkDescriptor(storageFieldChunkId, wrapper.refType, OBJECT_TYPE.arrayElementType)
...
class AssociativeArrayWrapper : WrapperInterface {
    ...
    override fun value(resolver: Resolver, wrapper: ObjectValue): UtModel {
        ...
        val touchedFieldDescriptor = memoryChunkDescriptor(touchedFieldChunkId, wrapper.refType, OBJECT_TYPE.arrayElementType)
