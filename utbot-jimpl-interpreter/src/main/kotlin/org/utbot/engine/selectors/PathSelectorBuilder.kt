...
import org.utbot.engine.soot.TypeRegistry
...
) : PathSelectorBuilder<org.utbot.engine.selectors.BFSSelector>(graph, context) {
    override fun build() = org.utbot.engine.selectors.BFSSelector(
